...
tablero=Tablero()
#persona
player1 = Player('Julian',fichas[0:7])
#bots
player2 = Player('Felipe',fichas[7:14])
player3 = Player('Daniel',fichas[14:21])
player4 = Player('Luis',fichas[21:28])

#designacion de turnos
Player.designacion_turnos()

Player.players[0].jugar((6,6),tablero)
print(tablero.fichas)
print(Player.players[0].fichas)